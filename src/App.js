...
const createElement = (id, x1, y1, x2, y2, type, pencilSize = 3) => {
  switch (type) {
    ...
    case "pencil":
      return { id, type, points: [{ x: x1, y: y1 }], size: pencilSize };
    case "text":
...
const drawElement = (roughCanvas, context, element) => {
  switch (element.type) {
    ...
    case "rectangle":
      ...
      break;
    case "pencil":
      const stroke = getSvgPathFromStroke(getStroke(element.points, {size: element.size}));
...
const App = () => {
  ...
  <label htmlFor="eraser">Eraser</label>
      ...
      <div>
        {tool === "pencil" && (
      <div style={{ display: 'flex', alignItems: 'center', gap: '0px', position:"fixed", padding:'20px', right:'20',zIndex:'2', top:'20'}}>
